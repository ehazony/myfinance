...
const ImageModal: React.FC<ImageModalProps> = ({ visible, imageUrl, onClose }) => {
  ...
  const maxHeight = screenHeight - 200 // Leave space for close button and safe areas
  
  // Use 4:3 aspect ratio which works well for charts, but constrain to screen
  const aspectRatio = 4 / 3
  let imageWidth = maxWidth
  let imageHeight = maxWidth / aspectRatio
  
  // If height is too tall for screen, scale down proportionally
        ...
        >
          <SafeAreaView style={styles.container}>
            ...
            <TouchableOpacity
              ...
              activeOpacity={1}
              onPress={() => {}} // Prevent backdrop press when touching image
            >
              <Animated.View
                style={[
                  styles.imageWrapper,
