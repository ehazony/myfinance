...
def create_reporting_agent() -> Agent:
    ...
    return Agent(
        ...
        **When retrieving transactions, you may use either or both of date range and category as filters, but neither is required. If the user does not specify, return the most recent transactions. Do not require both parameters.**
