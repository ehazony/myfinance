...
from ...models.resend_email_verification import ResendEmailVerification
...
def _get_kwargs(
    *,
    ...
    if isinstance(body, ResendEmailVerification):
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = RestAuthDetail.from_dict(response.json())
