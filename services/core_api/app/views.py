...
# Comment out telegram_bot import as it's moved to separate service
...
# Comment out agents import as it's moved to separate service  
...
class ChatSendView(APIView):
    ...
    @extend_schema(
        ...
        responses=PolymorphicProxySerializer(
            ...
            serializers=lambda: [MessageSerializer],  # Simplified - will update when agents are connected
