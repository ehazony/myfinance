...
# Regular user-facing API patterns
urlpatterns = [
...
# Agent Service API patterns (OpenAPI documented)
agent_api_patterns = [
    path('api/agent/financial-context/', agent_api.AgentFinancialContextView.as_view(), name='agent_financial_context'),
    path('api/agent/transactions/', agent_api.AgentTransactionsView.as_view(), name='agent_transactions'),
    path('api/agent/budget-analysis/', agent_api.AgentBudgetAnalysisView.as_view(), name='agent_budget_analysis'),
    path('api/agent/account-summary/', agent_api.AgentAccountSummaryView.as_view(), name='agent_account_summary'),
    path('api/agent/conversation-context/', agent_api.AgentConversationContextView.as_view(), name='agent_conversation_context'),
]
...
urlpatterns += agent_api_patterns
