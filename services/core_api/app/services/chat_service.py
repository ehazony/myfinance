...
# Comment out agents import - will be replaced with service communication
...
class ChatService:
    ...
    def __init__(self, orchestrator=None) -> None:
        # TODO: Replace with AgentServiceClient for inter-service communication
        self.orchestrator = None  # orchestrator or Orchestrator()
        logger.warning("ChatService initialized without agent orchestrator - using fallback responses")
    ...
    def send_message(self, user: get_user_model(), text: str) -> Message:
        ...
        # TODO: Replace with HTTP call to agent service
        # For now, provide a fallback response
        logger.warning("Agent service not available, providing fallback response")
        
        # Generate a simple response based on the financial context
